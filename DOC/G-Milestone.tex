...
\lstdefinelanguage{SML}{
    morekeywords={ if, val, fun, let, in, end, then, else, andalso, orelse },% ifelse, else, repeat, until, to, downto, return, and, or},
    morecomment=[s]{(*}{*)},
    morestring=[bd]',
    morestring=[bd]",
    sensitive=false,
...
\begin{lstlisting}
    | typeCheckExp ( vtab, AbSyn.Not (e,    pos), _ ) =
        ...
        in  if  typesEqual(BType Bool, e_type)
            then Not(e_new, pos)
            else raise Error("in type check and exp, one
                              argument is not of bool type "^
